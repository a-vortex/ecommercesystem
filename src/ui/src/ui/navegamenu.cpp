...
namespace ecommerce::ui
{
    ...
    Menu *NavegaMenu::navegamenunext(unsigned option, Estoque estoque, Busca busca)
    {
        ...
        case 2:
        {
            ...
            funcoes::busca_produtos_nome(pesquisa, estoque.lista_produtos()).GetName();
        }
        break;
        case 3:
        {
            ...
            funcoes::busca_produtos_tipo(pesquisa, estoque.lista_produtos());
        }
        ...
        case 4:
        {
            ...
            funcoes::busca_produtos_preco(number, estoque.lista_produtos());
        }
        break;
        default:
            break;
